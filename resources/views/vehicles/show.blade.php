        ...
        <div class="modal-body">
            <div class="card">
                <ul class="list-group list-group-flush">
                    ...
                    <div class="col-md-8">
                        <li class="list-group-item text-right"><strong>TND {{ $vehicle->packing_charge }} </strong></li>
                    </div>
                </div>
                    <div class="row">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-8">
                            <li class="list-group-item text-right"><strong> TND {{ $vehicle->duration *  $vehicle->packing_charge }}</strong></li>
                        </div>
                        </div>
